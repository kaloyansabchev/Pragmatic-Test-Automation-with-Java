public class College {
    ...
    public static void main(String[] args) {
        ...
        Student milena = new Student("Milena", "Math", 43, 8);
        ...
        Student kaloqn = new Student("Kaloqn", "Informatic", 25, 5);
        ...
        System.out.println();
        System.out.println("The free places for the next year \"Math\" group are " + maths.getFreePlaces() + ".");
        System.out.println("The free places for the next year \"Informatics\" group are " + informatics.getFreePlaces() + ".");
